// Platform: tabris
// 291aa8a0df9d73c3b907a4c412e332f8f26212a5
/*
...
// file: src/legacy-exec/tabris/android/nativeapiprovider.js
...
// file: src/legacy-exec/tabris/android/promptbasednativeapi.js
...
// file: src/legacy-exec/tabris/exec.js
...
var cordovaBridge = (function() {
  ...
  function processAndroidEvent(event) {
  ...
  function getPlugin(service) {
    var plugin = pluginProxies[service];
    if (typeof plugin === "undefined") {
      var Plugin = tabris.NativeObject.extend('cordova.plugin');
      tabris.NativeObject.defineProperties(Plugin.prototype, {service: {type: {}, nocache: true}});
      plugin = new Plugin({service: service});
      plugin._nativeListen('finish', true);
...
// file: src/legacy-exec/tabris/platform.js
...
// file: src/legacy-exec/tabris/plugin/android/app.js
