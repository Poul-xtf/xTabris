...
AndroidManifest.prototype.getActivity = function () {
    ...
    return {
        ...
        setSplashTheme: function (theme) {
            if (theme) {
                activity.attrib['android:theme'] = theme;
            }
            return this;
        },
...
AndroidManifest.prototype.setApplicationTheme = function(value) {
  if (value) {
    this.doc.getroot().find('./application').attrib['android:theme'] = value;
  }
  return this;
};
